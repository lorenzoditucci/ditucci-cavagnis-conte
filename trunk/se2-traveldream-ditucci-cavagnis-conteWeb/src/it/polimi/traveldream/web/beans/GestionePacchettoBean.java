...
public class GestionePacchettoBean {
	...
	public String salvaModifichePacchetto(){
		...
		if(!gestionePacchettoMgr.controllaChePacchettoNonFacciaParteDiGL(this.pacchetto)){
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,"Il pacchetto fa parte di una GL e non può essere modificato", "Modifiche non salvate"));	
			return null;
		}
